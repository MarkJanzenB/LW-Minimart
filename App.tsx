...
function App() {
  ...
  const total = subtotal; // Assuming prices are tax inclusive or tax is added separately? Let's assume inclusive for simplicity or add it. The screenshot shows VAT breakdown but total matches items sum often. Let's do simple sum.
  // Actually screenshot shows: Subtotal, VAT (12%), Total. 
  // Let's assume Total = Subtotal (inclusive) for now to match the "P6.18" example in screenshot where items sum to 6.18.
